# Generated by Django 4.2.2 on 2023-06-07 20:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('times_accessed', models.IntegerField(db_comment='Number of times the URL was accessed.', default=0)),
            ],
        ),
        migrations.RunSQL("""
            ...
            ALTER TABLE api_shorturlstats ALTER COLUMN times_accessed SET DEFAULT 0;
        """, reverse_sql='')
    ]
